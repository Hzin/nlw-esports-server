...
INSERT INTO "new_Ad" ("createdAt", "discord", "gameId", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying", "hourStart", "hourEnd") SELECT "createdAt", "discord", "gameId", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying", "hoursStart", "hoursEnd" FROM "Ad";
DROP TABLE "Ad";
